 ...
 * Card (spec #11). Decision Card v0.2 added the Skyflow-shaped
...
export const PROTOCOLS: ProtocolSummary[] = [
  ...
  },
  {
    ...
    shortBlurb:
      'The buyer-side artifact. Records the outcome of a procurement review of one or more vendor declarations: documents reviewed (by URL + content hash), rubric, conditions, rationale, signatures. v0.2 adds data_vault_targets[] — Skyflow-shaped field-level vault contract. v0.3 adds retention_envelope[] — per-field TTL + redaction action + signed deletion-proof endpoint. Natural carrier for NIST AI RMF-aligned procurement decisions.',
